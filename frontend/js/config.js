const CONFIG = {
    ...
    FALLBACK_POSTER: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="300" height="450" fill="%230a0a1a">' +
        ...
        '</svg>'),
    FALLBACK_TV_POSTER: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="300" height="450" fill="%230a0a1a">' +
        '<rect width="300" height="450"/>' +
        '<text x="150" y="215" fill="%23333" font-family="sans-serif" font-size="60" text-anchor="middle">📺</text>' +
        '<text x="150" y="260" fill="%23444" font-family="sans-serif" font-size="14" text-anchor="middle">No Poster</text>' +
        '</svg>'),
    FALLBACK_BOOK_POSTER: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="300" height="450" fill="%230a0a1a">' +
        '<rect width="300" height="450"/>' +
        '<text x="150" y="215" fill="%23333" font-family="sans-serif" font-size="60" text-anchor="middle">📚</text>' +
